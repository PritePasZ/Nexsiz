...
module.exports.run = async (bot, message, args) => {
    ...
    .setTimestamp()
    .setTitle(`Click here to join CorosiveZ discord server`)
    ...
    .addField(`:clipboard: Created by`, `CorosiveZ#3071`, true)
    ...
    .setFooter("Made by Corosive","https://cdn.discordapp.com/avatars/346579836292300800/b02ca29aee1ec133c84377bd4235e957.png")
    .setTimestamp();
