...
module.exports.run = async (bot, message, args) => {
  ...
  .addField("<:bustinsilhouette:553086092837126145> ผู้ใช้ทั้งหมด", message.guild.memberCount - message.guild.members.filter(m => m.user.bot).size, true)
  .addField(":robot: บอททั้งหมด", message.guild.members.filter(m => m.user.bot).size, true)
