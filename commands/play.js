...
module.exports.run = async (bot, message, args) => {
        ...
        if (!permissions.has("CONNECT")) return message.channel.send(":x: I cannot connect to your voice channel, make sure I have permission to!");
        if (!permissions.has("SPEAK")) return message.channel.send(":x: I cannot connect to your voice channel, make sure I have permission to!");

        if (!args[0]) return message.channel.send(":x: Please provide a song name or link to search.");
