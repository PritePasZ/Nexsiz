...
let infoembed = new Discord.RichEmbed()
    .setColor(`#00802b`)
    .addField(`:information_source: Informations Command`, `**n!minecraft**`)
    ...
    .addField(`:tools: Moderation Commands`, `**n!ban**, **n!clear**, **n!report**, **n!say**, **n!removerole**, **n!mute**, **n!poll **, **n!kick**, **n!unmute**`)
